...
;(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['movie-frontend/src/assets/scripts/jquery'], factory);
    } else if (typeof exports !== 'undefined') {
        module.exports = factory(require('movie-frontend/src/assets/scripts/jquery'));
    } else {
        factory(jQuery);
    }
